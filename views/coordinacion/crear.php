...
?>
        ...
        <div class="form-container">
            <div class="form-card">
                <form id="formCrearCoordinacion" method="POST" action="procesar.php" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-hint">Ingrese el nombre completo de la coordinación académica.</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            ?>
                                <option value="<?php echo htmlspecialchars($centro['cent_id']); ?>" <?php echo (isset($old['centro_formacion_cent_id']) && $old['centro_formacion_cent_id'] == $centro['cent_id']) ? 'selected' : ''; ?>>
